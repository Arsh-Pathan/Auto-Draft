  ...
  const payload: ReportPayload = useMemo(
    () => ({
      meta: {
        ...
        eventCoordinator: form.eventCoordinator,
        projectTrack: form.projectTrack,
        teamStructure: form.teamStructure,
        techStack: form.techStack,
        totalFinancialRequest: form.totalFinancialRequest,
      ...
      signatories: {
        ...
        technicalLead: form.technicalLead || SIGNATORIES.technicalLead,
        eventCoordinator: form.eventCoordinator || SIGNATORIES.eventCoordinator,
      },
    }),
    [form, ai, photos]
  );
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex shrink-0 gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:scale-[1.02]"
            >
